...
P__tilde__xr = Particle(pdg_code = 5000511,
                        name = '~xr',
                        antiname = '~xr',
                        spin = 1,
                        color = 1,
...
P__tilde__xc = Particle(pdg_code = 5000512,
                        name = '~xc',
                        antiname = '~xcb',
                        spin = 1,
                        color = 1,
...
P__tilde__xcb = P__tilde__xc.anti()

P__tilde__xd = Particle(pdg_code = 5000521,
                        name = '~xd',
                        antiname = '~xdb',
                        spin = 2,
                        color = 1,
...
P__tilde__xdb = P__tilde__xd.anti()

y0 = Particle(pdg_code = 5000000,
              name = 'y0',
              antiname = 'y0',
              spin = 1,
              color = 1,
