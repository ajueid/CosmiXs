...
Decay_y0 = Decay(name = 'Decay_y0',
                 ...
                 partial_widths = {(P.b,P.b__tilde__):'((-12*gSd33**2*MB**2*yb**2 + 3*gPd33**2*MY0**2*yb**2 + 3*gSd33**2*MY0**2*yb**2)*cmath.sqrt(-4*MB**2*MY0**2 + MY0**4))/(16.*cmath.pi*abs(MY0)**3)',
                                   ...
                                   (P.P__tilde__xcb,P.P__tilde__xc):'(gSXc**2*MXc**2*cmath.sqrt(-4*MXc**2*MY0**2 + MY0**4))/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.P__tilde__xd,P.P__tilde__xdb):'((-8*gSXd**2*MXd**2 + 2*gPXd**2*MY0**2 + 2*gSXd**2*MY0**2)*cmath.sqrt(-4*MXd**2*MY0**2 + MY0**4))/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.P__tilde__xr,P.P__tilde__xr):'(gSXr**2*MXr**2*cmath.sqrt(-4*MXr**2*MY0**2 + MY0**4))/(32.*cmath.pi*abs(MY0)**3)'})
