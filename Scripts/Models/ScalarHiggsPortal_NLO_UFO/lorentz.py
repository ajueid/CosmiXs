...
VVV11 = Lorentz(name = 'VVV11',
                spins = [3, 3, 3],
                structure = 'P(3,3)*Metric(1,2) - P(2,1)*Metric(1,3) - P(2,3)*Metric(1,3) - P(1,2)*Metric(2,3) - P(1,3)*Metric(2,3)')


VVV12 = Lorentz(name = 'VVV12',
                spins = [3, 3, 3],
                structure = 'P(3,3)*Metric(1,2) - (P(2,1)*Metric(1,3))/3. + (2*P(2,2)*Metric(1,3))/3. - (P(2,3)*Metric(1,3))/3. - P(1,2)*Metric(2,3) - P(1,3)*Metric(2,3)')
