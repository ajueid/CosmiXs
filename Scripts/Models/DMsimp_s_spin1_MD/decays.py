...
Decay_y1 = Decay(name = 'Decay_y1',
                 ...
                 partial_widths = {(P.b,P.b__tilde__):'((-48*gAd33**2*MB**2 + 24*gVd33**2*MB**2 + 12*gAd33**2*MY1**2 + 12*gVd33**2*MY1**2)*cmath.sqrt(-4*MB**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)',
                                   ...
                                   (P.e__minus__,P.e__plus__):'((-16*gAl11**2*Me**2 + 8*gVl11**2*Me**2 + 4*gAl11**2*MY1**2 + 4*gVl11**2*MY1**2)*cmath.sqrt(-4*Me**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)',
                                   (P.mu__minus__,P.mu__plus__):'((-16*gAl22**2*MMU**2 + 8*gVl22**2*MMU**2 + 4*gAl22**2*MY1**2 + 4*gVl22**2*MY1**2)*cmath.sqrt(-4*MMU**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)',
                                   ...
                                   (P.P__tilde__xcb,P.P__tilde__xc):'((-(gVXc**2*MXc**2) + (gVXc**2*MY1**2)/4.)*cmath.sqrt(-4*MXc**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)',
                                   (P.P__tilde__xd,P.P__tilde__xdb):'((-16*gAXd**2*MXd**2 + 8*gVXd**2*MXd**2 + 4*gAXd**2*MY1**2 + 4*gVXd**2*MY1**2)*cmath.sqrt(-4*MXd**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)'})
